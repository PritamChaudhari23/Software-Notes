...
* Overview: Web portal for scholarship application and processing of needful students as
  CSR activity of Bluestar foundation.
* Technology: React JS, Material UI, Axios, Redux toolkit, Redux-Saga, Formik, Yup,
  React router, NPM
* Responsibilities:
