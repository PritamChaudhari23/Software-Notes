...
- Web APIs (not part of JS engine but present in browsers) => Handle browser operations like `setTimeout`, `fetch`, DOM events
- Callback Queue/Task Queue/Message Queue) – Stores callbacks from Web APIs.
