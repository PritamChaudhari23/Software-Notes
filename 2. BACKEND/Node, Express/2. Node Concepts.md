...
- **Single threaded**: It executes one main thread sequentially.
...
- **Worker threads:** For CPU-heavy tasks, Node.js supports **worker threads** to run JavaScript in **parallel** .
